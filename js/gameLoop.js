...
playerImage.src = "./image/totoro.png";
...
monsterImage.src = "./image/dust.png";
...
var render = function(){
	...
	ctx.fillText("捕まったススワタリ： " + monstersCaught, 600, 650);
	
	ctx.fillStyle = "#f1f2f2";
	ctx.font = "bold 30px serif";
	ctx.textAlign = "start";
	ctx.textBaseline = "Hanging";
	ctx.fillText("時間: " + parseInt(i), 750, 50);
};
